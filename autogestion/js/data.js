...
export const runtime = { mode: null, services: [], selectedServiceId: null, servicesUnavailable: false, paymentsEnabled: false, phantomPostingEnabled: false, paymentHistoryEnabled: false, paymentItems: [], paymentError: '', paymentHistoryItems: [], paymentHistoryError: '', billingView: 'invoices', billingRefreshing: false, backend: true, loading: false, error: '', warnings: [], nextOffset: null, endReached: false, invoicesLoading: false };
...
export function clearData() { runtime.paymentItems = []; runtime.paymentError = ''; runtime.paymentHistoryItems = []; runtime.paymentHistoryError = ''; customer = emptyCustomer(); invoices = []; ticket = null; debt = null; credit = null; nextDue = null; runtime.nextOffset = null; runtime.endReached = false; runtime.invoicesLoading = false; runtime.warnings = []; }
