...
export const runtime = { mode: null, backend: true, loading: false, error: '', warnings: [], nextOffset: null, endReached: false, invoicesLoading: false };
...
export function clearData() { customer = emptyCustomer(); invoices = []; ticket = null; debt = null; credit = null; nextDue = null; runtime.nextOffset = null; runtime.endReached = false; runtime.invoicesLoading = false; runtime.warnings = []; }
