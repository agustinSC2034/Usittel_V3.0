...
export const runtime = { mode: null, services: [], selectedServiceId: null, servicesUnavailable: false, paymentsEnabled: false, phantomPostingEnabled: false, paymentHistoryEnabled: false, paymentItems: [], paymentError: '', paymentHistoryItems: [], paymentHistoryError: '', movementPage: 0, billingView: 'invoices', billingRefreshing: false, backend: true, loading: false, error: '', warnings: [], nextOffset: null, endReached: false, invoicesLoading: false };
...
export function applyOverview(data) {
  runtime.serviceOptions=data.serviceOptions||[];runtime.serviceRequests=data.serviceRequests||[];runtime.serviceRequestsUnavailable=data.serviceRequestsUnavailable===true;
