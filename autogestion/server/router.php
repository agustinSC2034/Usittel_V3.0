...
header("Content-Security-Policy: default-src 'self'; script-src 'self'; worker-src 'self'; style-src 'self' 'unsafe-hashes' 'sha256-m3XTiIF20AAl/JoLbhZCLpVDCCo+QhhIqpqq9SZ30Dk=' 'sha256-xjSPVmGV0Y7/JlI96tkhFBO+AHUksst6E8tDPt/2NeE=' 'sha256-V8QGUX4MXzgFdnAPNatwxhqsqAeBZaBVFtuTimRliPQ=' 'sha256-YF4wjlVuVuSmlr59JBTrY/SzJ7kLa9B/bG+6O1sXP1M='; img-src 'self'; font-src 'self'; connect-src 'self'".$measurementOrigin."; object-src 'none'; frame-src https://www.metercustom.net; frame-ancestors 'none'; base-uri 'self'; form-action 'none'");
